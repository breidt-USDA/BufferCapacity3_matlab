...
%Takes a concentration (in moles/liter) and a pK, and returns a BC value 
%  for that concentration at the given pH.
%INPUT: 
%   ABmat: Nx2 matrix with conc (M) and pK of buffer(s)
%OUTPUT:
%   BCmat: Nx2 matrix with Beta value, and pK
